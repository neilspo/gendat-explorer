...
$query = "SELECT a.*, b.name FROM ns_deaths a JOIN ns_deaths_data b USING (Deathid) ORDER BY a.LastName, a.Year, a.FirstName, a.Deathid";
//$query = "SELECT a.*, b.name FROM ns_deaths a JOIN ns_deaths_data b USING (Deathid)";
